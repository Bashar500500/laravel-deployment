...
class LearningActivityRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            ...
            'content.data.captions' => ['sometimes', 'missing_if:content.type,==,' . implode(',', LearningActivityType::Video->getEnumsExceptValue()), 'array'],
            'content.data.captions.url' => ['sometimes', 'missing_if:content.type,==,' . implode(',', LearningActivityType::Video->getEnumsExceptValue()), 'url'],
    ...
    protected function onUpdate() {
        return [
            ...
            'content.data.video' => ['sometimes', 'missing_if:content.type,==,' . implode(',', LearningActivityType::Video->getEnumsExceptValue()), 'file', 'mimes:mp4,mov,ogg,qt,ogx,oga,ogv,webm'],
            'content.data.captions' => ['sometimes', 'missing_if:content.type,==,' . implode(',', LearningActivityType::Video->getEnumsExceptValue()), 'array'],
            'content.data.captions.url' => ['required_with:content.data.captions', 'missing_if:content.type,==,' . implode(',', LearningActivityType::Video->getEnumsExceptValue()), 'url'],
            'thumbnailUrl' => ['sometimes', 'url'],
