...
namespace App\Http\Requests\ReusableContent;
...
class ReusableContentRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            ...
            'type' => ['required', new Enum(ReusableContentType::class)],
            'tags' => ['required', 'array'],
            ...
            'file' => [
                ...
                (($this->request->get('type') == ReusableContentType::Video->getType() ?
                    ...
                    $this->request->get('type') == ReusableContentType::Presentation->getType()) ?
                    'mimes:ppt,pptx,odp' :
                    $this->request->get('type') == ReusableContentType::Pdf->getType()) ?
                    'mimes:pdf' :
                    '',
            ],
        ];
    ...
    protected function onUpdate() {
        return [
            ...
            'type' => ['sometimes', new Enum(ReusableContentType::class)],
            'tags' => ['sometimes', 'array'],
            'tags.*' => ['required_with:tags', 'string'],
            'share_with_community' => ['sometimes', 'boolean'],
            'file' => [
                'required_with:type',
                'file',
                (($this->request->get('type') == ReusableContentType::Video->getType() ?
