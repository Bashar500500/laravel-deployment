...
class RubricRequest extends FormRequest
{
    ...
    protected function onStore() {
        return [
            ...
            'rubric_criterias.*.levels.s1' => ['required', 'array'],
            'rubric_criterias.*.levels.s1.points' => ['required', 'integer', 'lt:rubric_criterias.*.levels.good.points'],
            'rubric_criterias.*.levels.s1.description' => ['required', 'string'],
            'rubric_criterias.*.levels.s2' => ['required', 'array'],
            'rubric_criterias.*.levels.s2.points' => ['required', 'integer', 'lt:rubric_criterias.*.levels.s1.points'],
            'rubric_criterias.*.levels.s2.description' => ['required', 'string'],
            'rubric_criterias.*.levels.bad' => ['required', 'array'],
            'rubric_criterias.*.levels.bad.points' => ['required', 'integer', 'lt:rubric_criterias.*.levels.s2.points'],
            'rubric_criterias.*.levels.bad.description' => ['required', 'string'],
        ];
    }
    ...
    protected function onUpdate() {
        return [
            ...
            'rubric_criterias.*.levels.s1' => ['required_with:rubric_criterias.*.levels', 'array'],
            'rubric_criterias.*.levels.s1.points' => ['required_with:rubric_criterias.*.levels.s1', 'integer', 'lt:rubric_criterias.*.levels.good.points'],
            'rubric_criterias.*.levels.s1.description' => ['required_with:rubric_criterias.*.levels.s1', 'string'],
            'rubric_criterias.*.levels.s2' => ['required_with:rubric_criterias.*.levels', 'array'],
            'rubric_criterias.*.levels.s2.points' => ['required_with:rubric_criterias.*.levels.s2', 'integer', 'lt:rubric_criterias.*.levels.s1.points'],
            'rubric_criterias.*.levels.s2.description' => ['required_with:rubric_criterias.*.levels.s2', 'string'],
            'rubric_criterias.*.levels.bad' => ['required_with:rubric_criterias.*.levels', 'array'],
            'rubric_criterias.*.levels.bad.points' => ['required_with:rubric_criterias.*.levels.bad', 'integer', 'lt:rubric_criterias.*.levels.s2.points'],
            'rubric_criterias.*.levels.bad.description' => ['required_with:rubric_criterias.*.levels.bad', 'string'],
        ];
    }
